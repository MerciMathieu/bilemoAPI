 ...
 */
class AccessUserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    // /**
    //  * @return AccessUser[] Returns an array of AccessUser objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?AccessUser
    {
        return $this->createQueryBuilder('a')
            ->andWhere('a.exampleField = :val')
            ->setParameter('val', $value)
